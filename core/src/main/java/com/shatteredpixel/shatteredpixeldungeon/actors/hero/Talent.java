...
public enum Talent {
	...
	//Gunner T1
	IN_THE_GUNFIRE(127), GUNSLINGERS_INTUITION(128), SHOOT_THE_HEART(129), SAFE_RELOAD(130),
	//Gunner T2
	RELOADING_MEAL(131), ARM_ENHANCE(132), OBSCURATOON(133), VULNERABLE_BULLET(134), PEEKING(135),
	//Gunner T3
	MARTIALARTS(136, 3), STREET_FIGHTING(137, 3),
	//Desperado T3
	EXCELLENT_DEXTERITY(138, 3), RUN_AND_GUN(139, 3), GUN_RIOT(140, 3),
	//Swat T3
	FLASH_BANG(141, 3), SILENCER(142, 3), SLIDING(143, 3),
	//Buckshot T4
	ADDITIONAL_BULLET(144, 4), MATH_BUCKSHOT(145, 4), EXPLOSIVE_BUCKSHOT(146, 4),
	//Antimater Rifle T4
	CRITICAL_BULLET(147, 4), CHARGE_BULLET(148, 4), LAST_ONE_BULLET(149, 4),
	//Grenade Launcher T4
	HE_GRENADE(150, 4), HUGE_EXPLOSION(151, 4), SUPPORT_DROP(152, 4),
